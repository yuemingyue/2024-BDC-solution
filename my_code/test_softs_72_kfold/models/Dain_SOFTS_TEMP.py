...
from layers.Embed import DataEmbedding_inverted,Deform_Temporal_Embedding,DataEmbedding
from layers.Transformer_EncDec import Encoder, EncoderLayer, Decoder, DecoderLayer
from layers.SelfAttention_Family import AttentionLayer,FullAttention,FlowAttention
...
class Dain_SOFTS_TEMP(nn.Module):
    def __init__(self,seq_len,enc_in,enc_d_model,enc_d_core,pred_len,d_model,dropout,use_norm,d_core,d_ff,activation,e_layers,n_heads=1):
        super(Dain_SOFTS_TEMP, self).__init__()
